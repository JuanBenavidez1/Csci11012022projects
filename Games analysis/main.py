...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_values"], color = "blue", label = "Critic Ratings")

plt.scatter(df_main["first_release_date"], color = "red", label = "User Ratings")
...
df_main = pd.read_cvs("game-ratings-by-10-genres.csv")
...
plt.bar(df_follow.index - BAR_WIDTH / 2, df_follow["total_follows"], color = "blue", label = "Numbers of Follows", width = BAR_WIDTH)
...
df_main = pd.read_cvs("game-ratings-by-10-platforms.csv")
